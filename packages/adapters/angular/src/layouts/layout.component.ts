import { Component, Input, ViewEncapsulation, HostBinding, inject, OnInit, OnChanges, SimpleChanges, OnDestroy, effect, PLATFORM_ID, signal, computed } from '@angular/core';
...
export class FyLayoutComponent implements OnInit, OnChanges, OnDestroy {
  ...
  protected currentTheme = computed(() => this.fylib.config().theme?.theme || 'default');
